	...
	datasetProperties = propertyStore{
		...
		store: map[string]property{
			...
			`compressratio`: newProperty(
				subsystemDataset,
				`compression_ratio`,
				`The compression ratio achieved for the used space of this dataset.`,
				transformMultiplier,
				datasetLabels...,
			),
			...
			`refcompressratio`: newProperty(
				...
				`The compression ratio achieved for the referenced space of this dataset.  See also the "compression_ratio" property.`,
				transformMultiplier,
				datasetLabels...,
			),
